...
struct rgw_cls_link_olh_op {
  ...
  rgw_zone_set zones_trace;
  std::string if_nomatch; /* only create delete marker if etag matches */
  std::string if_match; /* only create delete marker if etag doesn't match */
